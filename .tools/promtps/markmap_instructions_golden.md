...
## Rules
- Produce the final Markdown in **one shot**. 
- Do not ask clarifying questions. 
- Do not explain your output. Output only the markmap.
...
**Language:** Output the mind map in the same language as the source material. 
...
- Can be rendered easily on (https://markmap.js.org/).
