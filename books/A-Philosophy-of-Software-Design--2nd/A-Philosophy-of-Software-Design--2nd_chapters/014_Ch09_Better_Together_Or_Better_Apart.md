...
:::: class_s4
::: class_s8z
![](image_rsrc2HF.jpg){.class_sft}
:::

[Figure 9.1:]{.class_s2by} This code processes incoming network packets of different types; for each type, if the packet is too short for that type, a message gets logged. In this version of the code, the [LOG]{.class_s2dc} statement is duplicated for several different packet types.
::::

:::: class_s4
::: class_s8z
![](image_rsrc2HG.jpg){.class_sft}
:::

[Figure 9.2:]{.class_s2by} A reorganization of the code from [Figure 9.1](part0013.xhtml#a2DU) so that there is only one copy of the [LOG]{.class_s2dc} statement.
::::
...
[rpcConn = connectionPool.getConnection(dest);]{.class_s2c2}

} catch (IOException e) {

[NetworkErrorLogger.logRpcOpenError(req, dest, e);]{.class_s2c2}

[return null;]{.class_s2c2}
...
[AddrPortTuple dest, Exception e) {]{.class_s2c2}

[logger.log(Level.WARNING, \"Cannot send message: \" + req +]{.class_s2c2}

[\". \\n\" + \"Unable to find or open connection to \" +]{.class_s2c2}
...
The [NetworkErrorLogger]{.class_s2c1} class contained several methods such as [logRpcSendError]{.class_s2c1} and [logRpcReceiveError]{.class_s2c1}, each of which logged a different kind of error[]{#page_73}.
...
[1](part0013.xhtml#a2E9){.class_s2ca}[Clean Code]{.class_s2c}, Robert C. Martin, Pearson Education, Inc., Boston, MA 2009
